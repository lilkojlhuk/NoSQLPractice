...
import { checkIsAuth, checkRole, getRoleUser, logout } from '../../redux/features/auth/authSlice'
            ...
            <nav className='navbar'>
                <div className='container'>
                    <div className='navbar__wrap'>
                        <a href="/" className='menu__logo'>NoSQL Practice</a>
                        {isAuth
                            ?
                            userRole === "ADMIN"
                                ?
                                <ul className='menu__list'>
                                    ...
                                    <li className='menu__item'><NavLink to={'/addcomm'} className='menu__item-link'>Додати коментар</NavLink></li>
                                    <li className='menu__item'><NavLink to={'/allcomm'} className='menu__item-link'>Коментарі</NavLink></li>
